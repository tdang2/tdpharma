...
* Current supported api calls. Refer to trello tdpos for more detailed for each end point. To get the latest routes,
* under the project folder terminal, type command rake:routes
