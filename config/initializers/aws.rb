...
S3_BUCKET = Aws::S3::Resource.new(region: ENV['S3_REGION']).bucket(ENV['S3_BUCKET_NAME'])
S3_PUBLIC_BUCKET = Aws::S3::Resource.new(region: ENV['S3_REGION']).bucket(ENV['S3_PUBLIC_BUCKET'])
